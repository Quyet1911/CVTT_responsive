...
document.getElementById('dayNameWidget-js').innerHTML = dayName + ',';
document.getElementById('day-Of-WeekWidget-js').innerHTML = `${day}/${month}/${year}`;
...
async function getWeather() {
    try {
        ...
        document.getElementById('weatherCityWidget-js').textContent = `${temperature}°C / ${temperature} - ${feelsLike}°C`;
...
function hideMegaMenu() {
    ...
    if(window.innerWidth <= 991){
        menuIcon.innerHTML = '<img src="./assets/img/icon24-menu-gray.svg" alt="">';
        hideSearchInput();
    }else{
...
// thay đổi menuIcon khi thu nhỏ màn hình
